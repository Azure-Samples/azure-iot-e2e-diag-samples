...
namespace SimulatedDevice
{
    class Program
    {
        ...
        private const string DeviceConnectionString = "HostName=RentuIoTHub.azure-devices.net;DeviceId=Arduino;SharedAccessKey=wyhKIGpS+0a0k5T9cBLPbrZSl1xgTMhPI6Ma4mfd5Mc=";

        private static int MESSAGE_COUNT = 200;
        ...
        static async Task ReceiveCommands(DeviceClient deviceClient)
        {
            ...
            while (true)
            {
                receivedMessage = await deviceClient.ReceiveAsync(TimeSpan.FromSeconds(10)).ConfigureAwait(false);
